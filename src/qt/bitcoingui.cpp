                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CashCash - CSBit") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CashCash - CSBit"), this);
    aboutAction->setStatusTip(tr("Show information about CashCash - CSBit"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the CashCash - CSBit help message to get a list with possible CashCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CashCash - CSBit client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("CashCash - CSBit"); // default title
