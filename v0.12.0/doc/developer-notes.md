...
- [Development guidelines](#development-guidelines)
    - [General CashCash - CSBit](#general-cashcash-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
CashCash - CSBit uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
CashCash - CSBit is a multi-threaded application, and deadlocks or other
...
However, in open source software such as CashCash - CSBit, where everyone uses
...
pay attention to for reviewers of CashCash - CSBit code.

General CashCash - CSBit
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CashCash - CSBit uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against CashCash - CSBit so that they can be integrated
